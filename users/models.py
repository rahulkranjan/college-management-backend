...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    institute = models.ForeignKey(Institute, on_delete=models.CASCADE, null=True, related_name='user_institute' )
    email = models.EmailField(max_length=100, blank=True, null=True)
    name = models.CharField(max_length=100, blank=True)
    roles = models.ForeignKey(Role, on_delete=models.CASCADE, default=5,blank=True)
